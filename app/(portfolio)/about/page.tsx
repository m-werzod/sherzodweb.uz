...
const skillItems = [
  ...
  ['Node.js', 'Express', 'PostgreSQL', 'Prisma ORM', 'REST APIs'],
  ['OpenAI / Claude / Gemini APIs', 'Prompt Engineering', 'Claude Code', 'n8n Automation'],
  ['Git', 'Figma', 'Vercel', 'Docker (Basics)'],
]
...
export default function AboutPage() {
  ...
  const skills = [
    { category: ui.legacyAbout.skillFrontend, items: skillItems[0] },
    { category: ui.legacyAbout.skillBackend, items: skillItems[1] },
    { category: ui.legacyAbout.skillAiAutomation, items: skillItems[2] },
    { category: ui.legacyAbout.skillTools, items: skillItems[3] },
  ]

  const services = [
    { title: ui.legacyAbout.serviceFrontendTitle, desc: ui.legacyAbout.serviceFrontendDesc, iconSrc: serviceIcons[0] },
    { title: ui.legacyAbout.serviceMotionTitle, desc: ui.legacyAbout.serviceMotionDesc, iconSrc: serviceIcons[1] },
    { title: ui.legacyAbout.serviceUiuxTitle, desc: ui.legacyAbout.serviceUiuxDesc, iconSrc: serviceIcons[2] },
  ]

  const languages = [
    { lang: ui.legacyAbout.langUzbekName, level: ui.legacyAbout.langNativeLevel, flag: 'https://flagcdn.com/w80/uz.png', fill: 100 },
    { lang: ui.legacyAbout.langEnglishName, level: ui.legacyAbout.langFluentLevel, flag: 'https://flagcdn.com/w80/gb.png', fill: 90 },
    { lang: ui.legacyAbout.langRussianName, level: ui.legacyAbout.langConversationalLevel, flag: 'https://flagcdn.com/w80/ru.png', fill: 45 },
  ]

  const certifications = [
    { title: ui.legacyAbout.certFrontendTitle, org: ui.legacyAbout.certFrontendOrg, badge: ui.legacyAbout.certFrontendBadge },
    { title: ui.legacyAbout.certProgramTitle, org: ui.legacyAbout.certProgramOrg, badge: null },
    { title: ui.legacyAbout.certPromptTitle, org: ui.legacyAbout.certPromptOrg, badge: null },
    { title: ui.legacyAbout.certIeltsTitle, org: ui.legacyAbout.certIeltsOrg, badge: null },
  ]

  const stats = [
    { label: ui.legacyAbout.statLiveLabel, value: '5+' },
    { label: ui.legacyAbout.statAiLabel, value: '40+' },
    { label: ui.legacyAbout.statLighthouseLabel, value: '98/100' },
    { label: ui.legacyAbout.statFasterLabel, value: '10x' },
  ]
      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          <p className="text-xs text-[#38bdf8] font-semibold tracking-[0.25em] uppercase mb-3">
            {ui.legacyAbout.eyebrow}
          </p>
          <h1 className="text-4xl md:text-5xl font-black text-white mb-6">
            {ui.legacyAbout.heading} <span className="text-[#38bdf8]">{ui.legacyAbout.headingHighlight}</span>
          </h1>

          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-4 text-slate-400 leading-relaxed">
              <p><Highlight text={ui.legacyAbout.paragraph1} /></p>
              <p><Highlight text={ui.legacyAbout.paragraph2} /></p>
              <p><Highlight text={ui.legacyAbout.paragraph3} /></p>
            </div>
            ...
            >
              ...
              <div className="relative w-full max-w-[340px] h-[480px] md:h-[540px] rounded-3xl overflow-hidden border border-white/10 shadow-2xl shadow-sky-950/40 bg-gradient-to-b from-slate-800/40 to-[#020617]">
                ...
                <div className="absolute bottom-0 left-0 right-0 z-20 p-5 bg-gradient-to-t from-[#020617] via-[#020617]/80 to-transparent">
                  ...
                  <p className="text-xs text-[#38bdf8] font-medium mt-0.5">{ui.legacyAbout.photoBadgeRole}</p>
                </div>
              </div>
            </motion.div>
          </div>
        ...
        >
          <h2 className="text-2xl font-black text-white mb-8">
            {ui.legacyAbout.technicalSkills}
          </h2>
        ...
        <motion.div
          ...
          className="mb-20"
        >
          <h2 className="text-2xl font-black text-white mb-8">{ui.legacyAbout.languagesHeading}</h2>
        ...
        <motion.div
          ...
          className="mb-20"
        >
          <h2 className="text-2xl font-black text-white mb-8">{ui.legacyAbout.certificationsHeading}</h2>
        ...
        <motion.div
          ...
          className="mb-20"
        >
          <h2 className="text-2xl font-black text-white mb-8">{ui.legacyAbout.whatIDo}</h2>
        ...
        >
          <h2 className="text-3xl font-black text-white mb-3">
            {ui.legacyAbout.ctaHeading}
          </h2>
          <p className="text-slate-400 mb-8 max-w-md mx-auto">
            {ui.legacyAbout.ctaBody}
          </p>
          <Link
            href="/contact"
